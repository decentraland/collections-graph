...
export class CreatorsDayData extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save CreatorsDayData entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type CreatorsDayData must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("CreatorsDayData", id.toString(), this);
    }
  }

  static load(id: string): CreatorsDayData | null {
    return changetype<CreatorsDayData | null>(store.get("CreatorsDayData", id));
  }
...
export class CollectorsDayData extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save CollectorsDayData entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type CollectorsDayData must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("CollectorsDayData", id.toString(), this);
    }
  }

  static load(id: string): CollectorsDayData | null {
    return changetype<CollectorsDayData | null>(
      store.get("CollectorsDayData", id)
    );
  }
